...
#define lSM6DSOX_OUT_X_L_H 0x29 // Second half of x-coordinates from Accelerometer
#define lSM6DSOX_OUT_Y_L_A 0x2a // First half of y-coordinates from Accelerometer
#define lSM6DSOX_OUT_Y_L_H 0x2b // Second half of y-coordinates from Accelerometer
#define lSM6DSOX_OUT_Z_L_A 0x2c // First half of z-coordinates from Accelerometer
#define lSM6DSOX_OUT_Z_L_A 0x2d // Second half of z-coordinates from Accelerometer
