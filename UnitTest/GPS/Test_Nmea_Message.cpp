...
int main()
{
    ...
    char *start_ptr, *end_ptr, *jump_ptr, *origin_ptr;

    double latitude, longitude;
    int SV_;
    int i = 0;
    char gps_string[100] = "GPGGA,12001,1200.201021,N,01011.51302,E,1,09,0.89,74.9,M,42.8,M,,*64";

    // char gps_string[100] = "GPGGA,183251.10,,,,,0,00,99.99,,,,,,*62*62";

    char *gps = gps_string;
    origin_ptr = strchr(gps, ',');
    start_ptr = strchr(++origin_ptr, ','); // find start of latitude field
