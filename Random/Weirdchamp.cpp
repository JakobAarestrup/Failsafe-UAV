...
{   
    char NS_[1];
    char EW_[1];
    char gps_string[] = "GPGGA,,1200.201021,,01011.51302,E,1,09,0.89,74.9,M,42.8,M,,*64";
    char *gps = gps_string;
    char *start_ptr, *end_ptr;

    start_ptr = strchr(gps, ',');   // find start of field #1
    start_ptr = strchr(++start_ptr, ','); // find start of field #2 - latitude
