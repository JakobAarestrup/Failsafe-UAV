...
public:
    ...
    void readPressure();                    /// Reads the pressure from the barometer
    void readTemperature();                 /// Reads the temperature from the barometer
    void calculatePressureAndTemperature(); /// Calculates the temperature compensated pressure
    void update();                          /// Updates the pressure using the class functions
