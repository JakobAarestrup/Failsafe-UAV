...
namespace UBX_protocol
{
    ...
    /*BAUDRATE*/
    // inline constexpr char BAUD[] = "\xB5\x62\x06\x00\x14\x00\x01\x00\x00\x00\xD0\x08\x00\x00\xC0\x12\x00\x00\x03\x00\x03\x00\x00\x00\x00\x00\xCB\xC4"; 4800
    inline constexpr char BAUD[] = "\xB5\x62\x06\x00\x14\x00\x01\x00\x00\x00\xD0\x08\x00\x00\x80\x25\x00\x00\x03\x00\x03\x00\x00\x00\x00\x00\x9E\x95"; // 9600
    ...
    inline constexpr size_t GP_Length = 17;

    /*SAVE*/
    inline constexpr char SAFE[] = "\xB5\x62\x06\x09\x0D\x00\x00\x00\x00\x00\xFF\xFF\x00\x00\x00\x00\x00\x00\x17\x31\xBF";
    inline constexpr size_t SAFE_Length = 22;
}
#endif