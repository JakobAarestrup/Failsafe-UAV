 ...
 */
    //Second IMU:
    I2Cdev::writeBytes(LSM6DSOX_ADDR2, LSM6DSOX_INT1_CTRL, 0b00000011); // Enable gyroscope and accelerometer data interrupt
    I2Cdev::writeBytes(LSM6DSOX_ADDR2, LSM6DSOX_CTRL2_G, 0b10011100); // Gyro = 416 Hz (High-Performance mode)
    I2Cdev::writeBytes(LIS3MDL_ADDR2, LSM6DSOX_CTRL1_XL, 0b011000000); // Acc = 416 Hz (High-Performance mode)
    I2Cdev::writeBytes(LIS3MDL_ADDR2, LSM6DSOX_CTRL3_C, 0b01000000); // Enable BDU
    I2Cdev::writeBytes(LIS3MDL_ADDR2, LSM6DSOX_CTRL7_G, 0b10000000); // Enable High-Performance mode for Gyro
