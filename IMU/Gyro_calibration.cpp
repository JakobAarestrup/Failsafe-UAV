...
I2Cdev::writeByte(LSM6DSOX_ADDR1, LSM6DSOX_CTRL2_G, 0b10011100);   // Gyro = 208 Hz (normal mode) 2000 dps
...
// Main loop
   // while(mymillis() < startofloop + 200)
    ...
    /*     startofloop = mymillis(); */
        ...
        float gxc = (gx*gyro_sensitivity)/1000000; // mdeg/S to
        float gyc = (gy*gyro_sensitivity)/1000000; 
        float gzc = (gz*gyro_sensitivity)/1000000; 
